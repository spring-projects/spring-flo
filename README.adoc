...
image::https://travis-ci.org/spring-projects/spring-flo.svg?branch=master[Build Status, link=https://travis-ci.org/spring-projects/spring-flo] image::https://www.versioneye.com/user/projects/5a0f034a0fb24f2a3bd2569f/badge.svg?style=flat-square[Dependency Status, link=(https://www.versioneye.com/user/projects/5a0f034a0fb24f2a3bd2569f] 
